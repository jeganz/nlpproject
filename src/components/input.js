    ...
    <div className="w-full md:w-1/2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 relative">
      <div className="flex flex-col items-center pb-6">
        ...
        <button
          ...
          id="delete-btn"
          onClick={textEraser}
          className="absolute top-5 right-5 opacity-70 text-white hover:text-white border bg-red-500 border-red-700 hover:bg-red-800 font-medium rounded-lg text-sm px-2 py-2 text-center me-2 mb-2 dark:border-red-500 dark:text-white dark:hover:text-white dark:hover:bg-red-600  transition-none"
        >
          <svg
